...
type TokensDBRepository struct {
	db *sql.DB
}

func NewTokensDBRepository(db *sql.DB) *TokensDBRepository {
	return &TokensDBRepository{db: db}
}

func (u *TokensDBRepository) CreateUid(userID int32, uid models.CachedTokens) error {
	var exist int8 = 0
...
func (u *TokensDBRepository) UpdateUid(userID int32, uid models.CachedTokens) error {
...
func (u *TokensDBRepository) DeleteUid(userID int32) error {
...
func (u *TokensDBRepository) GetUidByID(userID int32) (*models.CachedTokens, error) {
